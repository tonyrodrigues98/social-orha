...
export const libraryCatalog: readonly LibraryCatalogEntry[] = [
  ...
  { name: "React Aria", kind: "npm", status: "integrated", packages: ["react-aria-components", "react-aria", "react-stately", "@react-types/shared"], sourcePaths: ["src/components/godui/drawer.tsx", "src/app/pages/conversations-page.tsx"], note: "Semântica de overlay, foco e tabs; também sustenta os primitives do Untitled UI." },
  ...
  { name: "TanStack Query", kind: "npm", status: "integrated", packages: ["@tanstack/react-query"], sourcePaths: ["src/app/query-provider.tsx", "src/app/profile/profile-queries.ts"], note: "Cache, mutações e invalidação da identidade, preferências e mídia persistidas no Supabase." },
  { name: "TanStack Router", kind: "npm", status: "integrated", packages: ["@tanstack/react-router"], sourcePaths: ["src/app/router.tsx", "src/app/router-policy.ts"], note: "Browser history real, guards de Auth/onboarding, rotas recuperáveis e fallback de deep link para GitHub Pages." },
  ...
  { name: "Vidstack", kind: "npm", status: "installed", packages: ["@vidstack/react"], note: "Linha 1.15 compatível com React 19 instalada; permanece fora do runtime até existir um fluxo de vídeo aprovado." },
  ...
  { name: "react-easy-crop", kind: "npm", status: "integrated", packages: ["react-easy-crop"], sourcePaths: ["src/app/profile/profile-image-crop-drawer.tsx", "src/infrastructure/media/profile-image-processor.ts"], note: "Enquadramento acessível de avatar/capa e pipeline real Canvas para WebP antes do Storage." },
  { name: "Cropper.js", kind: "npm", status: "installed", packages: ["cropperjs"], note: "Alternativa low-level de crop." },
  { name: "Tiptap", kind: "npm", status: "installed", packages: ["@tiptap/react", "@tiptap/pm", "@tiptap/starter-kit", "@tiptap/extension-mention", "@tiptap/suggestion"], note: "Editor rich text e mentions com o peer oficial de sugestões instalado na mesma versão." },
  { name: "Lexical", kind: "npm", status: "installed", packages: ["lexical", "@lexical/react", "yjs"], note: "Editor alternativo altamente customizável; peer colaborativo Yjs disponível." },
  ...
  { name: "Emoji Mart", kind: "npm", status: "quarantined", packages: ["@emoji-mart/data", "@emoji-mart/react", "emoji-mart"], note: "Adapter declara peer até React 18; o peer de runtime está presente, mas não deve ser usado como default sem novo POC." },
  { name: "Uppy", kind: "npm", status: "installed", packages: ["@uppy/core", "@uppy/react", "@uppy/xhr-upload"], note: "Core/headless disponíveis; XHR não é usado no fluxo atual porque o adapter autenticado do Supabase Storage cobre diretamente imagens processadas de até 10 MB." },
  ...
  { name: "Algolia Autocomplete", kind: "npm", status: "installed", packages: ["@algolia/autocomplete-js", "algoliasearch", "@algolia/client-search", "search-insights"], note: "UI de autocomplete e peers oficiais disponíveis." },
