...
### P0.4 Completar a matriz E2E real multiusuário — concluída no staging
...
3. **Operação:** fornecer os sete valores jurídico/suporte, nomear moderação humana, provisionar observabilidade/alertas, definir o envelope e executar carga sustentada/backpressure e exercício de incidente; o baseline concorrente curto já está comprovado.
