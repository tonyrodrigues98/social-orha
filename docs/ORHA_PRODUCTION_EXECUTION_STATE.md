...
Commit-base publicado antes deste checkpoint: `7cf94d6`
...
- pendente: fechar a QA privada de teclado aberto, mídia quebrada, rede lenta e PWA em iPhone físico; WebKit autenticado emulado e sessão expirada real estão concluídos. Depois: domínio definitivo, PostHog/dashboards/alertas, prova de carga, escala humana e promoção controlada da produção.
