...
Commit-base publicado antes deste checkpoint: `33cfcb5`
...
Estado: **staging saudável e alinhado às 28 migrations locais; 40 tabelas públicas com RLS, 17 tabelas Realtime, cinco Edge Functions ativas, gates anônimo/CORS 7/7, autenticado catálogo/export/mídia 14/14, ciclo de conta 17/17, mensageria/mídia privada 18/18, domínio social 20/20, navegador social efêmero 3/3 e matriz de cinco papéis 16/16, dois jobs Cron ativos; Preview Vercel `Ready` porém ainda protegido por SSO; Auth remoto sincronizado; produção intacta**.
...
- pendente: fechar a QA privada de teclado aberto, mídia quebrada, rede lenta, sessão expirada, WebKit autenticado e PWA em iPhone físico; depois domínio definitivo, PostHog/dashboards/alertas, prova de carga, escala humana e promoção controlada da produção.
