...
Commit-base publicado antes deste checkpoint: `21f6c98`
...
- pendente: fechar a QA privada de teclado aberto, mídia quebrada, rede lenta, sessão expirada e PWA em iPhone físico; WebKit autenticado emulado está concluído. Depois: domínio definitivo, PostHog/dashboards/alertas, prova de carga, escala humana e promoção controlada da produção.
