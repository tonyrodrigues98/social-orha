...
Commit-base publicado antes deste checkpoint: `65777ae`
...
- pendente: fechar a QA privada de teclado aberto e PWA em iPhone físico; WebKit autenticado emulado, sessão expirada real, rede lenta e mídia quebrada estão concluídos. Depois: domínio definitivo, PostHog/dashboards/alertas, prova de carga, escala humana e promoção controlada da produção.
